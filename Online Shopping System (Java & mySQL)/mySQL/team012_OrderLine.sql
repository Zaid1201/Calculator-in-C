...
CREATE TABLE `OrderLine` (
  ...
  KEY `code_idx` (`code`),
  CONSTRAINT `code` FOREIGN KEY (`code`) REFERENCES `Product` (`code`) ON UPDATE CASCADE,
  CONSTRAINT `orderNumber` FOREIGN KEY (`orderNumber`) REFERENCES `Order` (`orderNumber`)
