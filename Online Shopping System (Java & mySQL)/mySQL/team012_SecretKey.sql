...
LOCK TABLES `SecretKey` WRITE;
/*!40000 ALTER TABLE `SecretKey` DISABLE KEYS */;
INSERT INTO `SecretKey` VALUES (1,_binary 'k\Ö$\Ça#œ°\ÛJ\0¿„¤_');
/*!40000 ALTER TABLE `SecretKey` ENABLE KEYS */;
UNLOCK TABLES;
